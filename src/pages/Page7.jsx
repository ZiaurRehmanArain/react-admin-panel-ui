  ...
  <section>
            <div className="w-full mx-auto px-6 py-3 ">
                <div className="flex flex-wrap text-start items-center space-x-4">
                    ...
                    {/* drop down  */}
                    <div className="w-[15%] h-16">
                        <label className="block text-sm font-medium text-gray-700">Langauge</label>
                        <Select
                        className="w-[100%]"
                    ...
                    <div className="flex  w-[90%] space-x-2  relative -left-4">
                        <div className="">
                            ...
                            <input type="text" placeholder="10"  className="h-10  p-2 rounded-md border-2 border-slate-200" />
                        </div>
                        <div className="">
                            <label htmlFor="">Width</label><br />
                            <input type="text" id='lastname' className="h-10 p-2 rounded-md  border-2 border-slate-200" placeholder="10"/>
                        </div>


                        <div className="w-[30%] mt-[5px]">
                        <label className="block text-sm font-medium text-gray-700">item</label>
                        <Select
                        className="w-[100%]"
                            options={langaugeDropDownData}
